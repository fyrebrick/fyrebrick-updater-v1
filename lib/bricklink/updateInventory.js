...
module.exports = async function main(fyrebrick_id,user){
    ...
    const progressBar = progress.create(totalItems, currentProccessed,{description:"Update inventory for "+user.username});
    ...
    for (const i of data){
        ...
        if(totalItems===currentProccessed){
            ...
            const inventoryItems = progress.create(all_inventory_items.length, 0,{
                description:"Cleaning inventory items for "+user.username,
            });
